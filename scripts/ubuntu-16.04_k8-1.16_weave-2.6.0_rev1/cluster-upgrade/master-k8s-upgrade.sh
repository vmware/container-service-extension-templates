...
echo 'upgrading packages to: kubelet=1.16.6-00 kubeadm=1.16.6-00 kubectl=1.16.6-00 kubernetes-cni=0.7.5-00'
...
apt-get -q install -y kubelet=1.16.6-00 kubeadm=1.16.6-00 kubectl=1.16.6-00 kubernetes-cni=0.7.5-00 --allow-unauthenticated
apt-mark hold kubeadm kubelet kubectl kubernetes-cni

echo 'upgrading kubeadm to v1.16.6'
...
sleep 120
kubeadm upgrade apply v1.16.6 -y
