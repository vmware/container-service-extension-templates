...
echo 'upgrading packages to: kubelet=1.15.12-00 kubeadm=1.15.12-00 kubectl=1.15.12-00 kubernetes-cni=0.7.5-00'
...
echo 'upgrading kubeadm to v1.15.12'
...
sleep 120
kubeadm upgrade apply v1.15.12 -y
