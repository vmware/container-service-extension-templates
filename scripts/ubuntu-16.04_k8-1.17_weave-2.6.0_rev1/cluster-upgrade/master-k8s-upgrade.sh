...
echo 'upgrading kubeadm to v1.17.2'
...
echo 'upgrading packages to: kubelet=1.17.2-00 kubectl=1.17.2-00 kubernetes-cni=0.7.5-00'
apt-get -q update -o Acquire::Retries=3 -o Acquire::http::No-Cache=True -o Acquire::http::Timeout=30 -o Acquire::https::No-Cache=True -o Acquire::https::Timeout=30 -o Acquire::ftp::Timeout=30
apt-get install -y --allow-change-held-packages kubelet=1.17.2-00 kubectl=1.17.2-00 kubernetes-cni=0.7.5-00 --allow-unauthenticated
